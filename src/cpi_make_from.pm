#!/usr/bin/perl -w
#
#indx#	cpi_make_from.pm - A table of commands to convert one file type to another
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	cpi_make_from.pm - A table of commands to convert one file type to another
#doc#	This is the crux of nene
########################################################################
