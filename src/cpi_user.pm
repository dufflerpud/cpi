#!/usr/bin/perl -w
#
#indx#	cpi_user.pm - Software for handling a web user
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	cpi_user.pm - Software for handling a web user
########################################################################
...
sub logout_select
	...
	"if(this.value==\"logout\") { window.location.href=\"${script_prefix}User?func=logout\";} else {window.location.href=\"$script_prefix\"+this.value;}";
