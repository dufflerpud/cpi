#!/usr/bin/perl -w
#
#indx#	cpi_translate.pm - Suite of software to make it easy to do multi-language software
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	cpi_translate.pm - Suite of software to make it easy to do multi-language software
########################################################################
