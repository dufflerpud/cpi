#!/usr/bin/perl -w
#indx#	cpi_file.pm - Core routines used by rest of CPI (file i/o etc)
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	cpi_file.pm - Core routines used by rest of CPI (file i/o etc)
########################################################################
...
our @EXPORT_OK = qw( );
our @EXPORT = qw( chmog cleanup yorn echodo fatal autopsy death_requested
