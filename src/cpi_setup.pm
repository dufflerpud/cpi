#!/usr/bin/perl -w
#
#indx#	cpi_setup.pm - Basically logging in for web applications
#@HDR@	$Id$
#@HDR@
...
########################################################################
#doc#	cpi_setup.pm - Basically logging in for web applications
########################################################################
...
use cpi_file qw( fatal cleanup new_stderr );
